...
*/
class BinaryEnv : public Learn::LearningEnvironment {
...
private:
    ...
    **/
    static const uint32_t NB_TRAINING_ELEMENTS = 329999; // 100% of the balanced database, else (unbalanced database) : 1136424
...
public:
    ...
    */
    BinaryEnv(std::vector<uint64_t> actions, uint64_t speAct, const uint64_t nbTrainingTargets, const uint64_t nbGeneTargetChange, const uint64_t nbValidationTarget, size_t seed)
